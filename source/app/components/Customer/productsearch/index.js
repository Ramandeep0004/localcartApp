...
const CustomerProductSearch = props => {
                                ...
                                products && products.length > 0 ||
                                            ...
                                            categories && categories.length > 0 ?
                                                <View style={styles.viewcate}>
                                                    ...
                                                    <FlatList
                                                        ...
                                                        renderItem={({ item }) => (
                                                            <TouchableOpacity onPress={() => props.navigation.navigate('customervegfruits', { item: item })}>
                                    ...
                                    props && props.resentSearch && props.resentSearch.inputValue && props.resentSearch.inputValue.length > 0 && keyword === null ||
                                        ...
                                        <View style={styles.viewrecord}>
                                            <NoRecord image={Images.search} message={t('EmptyStates.No results found')} style={styles.emptyContainer} />
                                        </View>
                            }
                        </View>
                    </View>
...
export default connect(mapStateToProps)(CustomerProductSearch);
