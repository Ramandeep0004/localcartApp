...
const EditOrder = (props) => {
    ...
    }, [isFocus, cartArray, productDetailPopup]);
    ...
    useEffect(() => {
        if (values && parseInt(values.deliveryType) === 1) {
            if ((savedAddress && savedAddress.cityId) && shopDetail) {   //if the user change the address
                ...
                if (finalTotalValue && (savedAddress && savedAddress.cityId)) {
                    getExtraChargesAmount();
                }
            }
        }
    ...
    const getOrderDetails = async () => {
        ...
        if (response && response.status) {
            ...
            setValues({
                ...
                deliveryCharges: data.delivery_charges ? data.delivery_charges : null,
        ...
        <>
                                ...
                                <View style={base.col6}>
                                    <TouchableOpacity onPress={() => setDatePickerVisibility(true)}>
                                        <Input
                                            ...
                                            onChangeText={e => handleTimes('deliveryDate', newdateformat(e))}
                                        />
            ...
            {productDetailPopup ?
                <ItemModal
                    ...
                    fromOrderSummary={'forHandleADD-To-Cart-Button'}
